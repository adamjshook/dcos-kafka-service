...
#rm -rf tools/ && curl https://infinity-artifacts.s3.amazonaws.com/tools.tgz | tar xz
...
if [ -z "$CLUSTER_URL" ]; then
    ...
    export CCM_AGENTS=5
    CLUSTER_INFO=$(./tools/launch_ccm_cluster.py)
...
# Run shakedown tests:
${REPO_ROOT_DIR}/tools/run_tests.py shakedown ${REPO_ROOT_DIR}/integration/tests/ ${REPO_ROOT_DIR}/integration/requirements.txt
